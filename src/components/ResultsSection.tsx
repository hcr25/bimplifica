  ...
  const results = [
    {
      ...
      percentage: "30%",
      subtitle: "Reduction in Change Orders",
      description: "Complete 24/7 visibility of real project progress from any device.",
      details: "Automatic progress reports compared to planned schedules."
    },
    {
      icon: <Target className="h-8 w-8" />, 
      title: "Less Construction Risks",
      percentage: "40%", 
      subtitle: "More Accurate Budgets",
      description: "Early detection of interferences (clashes) before reaching the site.",
    ...
    },
    {
      ...
      description: "Precise planning of labor and materials based on BIM models.",
      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Measurable improvements that transform construction project performance 
        ...
        <div className="bg-muted/30 rounded-2xl p-8 md:p-12 mb-16">
          <div className="text-center mb-12">
            <h3 className="text-3xl md:text-4xl font-bold text-primary mb-6">
              Differential Value: Complete Technological Integration
            </h3>
