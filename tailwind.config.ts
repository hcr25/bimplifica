	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'text-glow': {
					'0%, 100%': { textShadow: '0 0 20px rgba(255, 106, 0, 0.5)' },
			...
			animation: {
				...
				'slide-up-1': 'slide-up-stagger 1s ease-out 0.2s both',
				'slide-up-2': 'slide-up-stagger 1s ease-out 0.4s both',
				'slide-up-3': 'slide-up-stagger 1s ease-out 0.6s both',
